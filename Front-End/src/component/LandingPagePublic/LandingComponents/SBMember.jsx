...
const SBmember = ({ Position, onBack }) => {
  ...
  const renderPagination = () => {
    ...
    if (start > 1) {
      ...
      if (start > 2) pages.push(<span key="s-ell" className="mx-1">...</span>);
    }
    ...
    if (end < totalPages) {
      if (end < totalPages - 1) pages.push(<span key="e-ell" className="mx-1">...</span>);
      pages.push(
        <button
          key={totalPages}
  ...
  const hasActiveFilters =
    searchTerm ||
    (positionFilter !== null && positionFilter !== Position) ||
    fromDate ||
    toDate;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="mb-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div className="mb-4 w-full md:mb-0 md:w-1/2">
              <div className="relative">
                ...
                <input
                  ...
                  className="xs:text-sm w-full rounded-lg border border-gray-300 p-3 pl-10 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                {searchTerm && (
                  <button
            ...
            <button
              ...
              className="xs:text-[10px] ml-auto flex items-center justify-center rounded-lg bg-gray-100 px-4 py-2 hover:bg-gray-200 hover:shadow-sm md:justify-start"
            >
          ...
          {showFilters && (
            <div className="mt-4 grid grid-cols-1 gap-4 xs:gap-2 rounded-lg bg-gray-50 p-4 md:grid-cols-4 lg:grid-cols-6">
              {loading ? (
                <>
                  <SkeletonFilter />
                  <SkeletonFilter />
                ...
                <>
                  ...
                  <div className="md:col-span-2 lg:col-span-2">
                    <label className="mb-1 block text-sm font-medium text-gray-700 xs:text-[10px]">
                      Position
                    </label>
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="xs:text-[10px] w-full appearance-none rounded-lg border border-gray-300 bg-white p-3 pl-10 font-medium shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      >
                  ...
                  <div className="md:col-span-1 lg:col-span-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        min={1900}
                        max={2100}
                        className="xs:text-[10px] w-full rounded-lg border border-gray-300 p-3 pl-10 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                    </div>
                  </div>
      ...
      <button
        id="backToTopBtn"
        onClick={scrollToTop}
        className={`fixed bottom-8 right-8 rounded-full bg-blue-600 p-3 text-white shadow-lg transition-all hover:bg-blue-700 hover:shadow-xl ${
