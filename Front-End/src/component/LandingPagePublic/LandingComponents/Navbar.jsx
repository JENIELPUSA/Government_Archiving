                    ...
                    <div className="flex h-20 items-center justify-between">
                        ...
                        <div className="flex items-center">
                            <ul className="flex items-center space-x-1">
                                ...
                                {/* Legislative Tracking System Button - Desktop */}
                                <li>
                                    <button
                ...
                >
                    <div className="border-t border-blue-800 bg-blue-950 px-4 py-4">
                        ...
                        <ul className="space-y-1">
                            ...
                            {/* Legislative Tracking System Button - Mobile */}
                            <li>
                                <button
                                    onClick={handleOpenLegislativeTracker}
                                    className="flex w-full items-center rounded-lg px-4 py-3 text-sm font-semibold text-white transition-colors duration-200 hover:bg-blue-800"
                                >
                                    Legislative Tracking System
                                </button>
                            </li>
