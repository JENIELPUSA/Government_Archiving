...
const OfficialProfileLayout = ({ fullName, Position, onBack }) => {
    ...
    useEffect(() => {
        ...
        if (!isGroupPublicAuthor?.length || isGroupPublicAuthor.length < 2) {
            const finalImg = isGroupSpecificAuthor[0]?.memberInfo?.avatar?.url || isGroupSpecificAuthor[0]?.avatar?.url || "/placeholder-avatar.png";
            ...
            <div className="mx-auto max-w-6xl px-4 py-6 sm:py-8">
                <div className="mb-5">
                    ...
                    <p className="text-left text-lg font-medium text-gray-700 sm:text-xl md:text-2xl">
                        {(() => {
                            const pos = profileData.Position || Position;
                            const displayPos =
                                {
                                    ...
                                    <div className="relative">
                                        <img
                                            ...
                                            className={`mx-auto h-48 w-48 rounded-lg border-2 border-gray-200 object-cover sm:h-64 sm:w-64 md:mx-0 md:h-[340px] md:w-64 ${
                                                shuffling ? "animate-shuffle-pulse border-blue-300" : "animate-pop-in border-gray-300"
                                        ...
                                        {!shuffling && imageKey > 0 && (
                                            <div className="animate-glitch absolute inset-0 opacity-0">
                                                <img
                                                    src={currentImage}
                                                    alt="glitch effect"
                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            <th
                                                scope="col"
                                                className="px-3 py-2 text-left text-xs font-medium uppercase tracking-wider text-gray-700 sm:px-6 sm:py-3"
                                            >
                                                Position
                                            </th>
                                            <th
                                    ...
                                    <tbody className="divide-y divide-gray-200 bg-white">
                                        {isSummaryTerm && isSummaryTerm.length > 0 ? (
                                            ...
                                            <tr>
                                                <td
                                                    colSpan="4"
                                                    className="px-3 py-3 text-center text-sm text-gray-500 sm:px-6 sm:py-4"
                                                >
