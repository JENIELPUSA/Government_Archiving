        ...
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mb-20 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg sm:text-xl text-gray-400 font-light leading-relaxed">
              Your trusted source for <span className="text-blue-400 font-medium">provincial</span> news
            </p>
          </div>
            ...
            displayedNews.map((news, index) => (
              ...
              >
                ...
                <div className={`relative overflow-hidden ${
                  ...
                  <img
                    src={news.image || getFallbackImage()}
                    alt={news.title}
                  ...
                  <div className="absolute right-4 top-4">
                    <div className="group/badge relative overflow-hidden rounded-2xl px-4 py-2 backdrop-blur-xl border transition-all duration-300 bg-gradient-to-r from-blue-500/90 to-cyan-500/90 border-blue-400/30 shadow-lg shadow-blue-500/30">
                ...
                <div className="relative flex flex-1 flex-col p-6 sm:p-8">
                  ...
                  <div className="mt-auto flex items-center justify-between gap-4">
                    ...
                    <button
                      ...
                      className="group/btn relative overflow-hidden rounded-2xl px-6 py-3 text-sm font-bold text-white transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95 bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 hover:shadow-blue-500/50"
                    >
