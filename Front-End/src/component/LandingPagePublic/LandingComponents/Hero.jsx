...
const Hero = ({ formData }) => {
    ...
    const parallaxValues = {
        sky: { y: scrollY * 0.1 * mobileFactor + mousePosition.y * mouseFactor * 0.1, x: mousePosition.x * mouseFactor * 0.1 },
        mountain: { y: scrollY * 0.3 * mobileFactor + mousePosition.y * mouseFactor * 0.3, x: mousePosition.x * mouseFactor * 0.3 },
        text: { y: scrollY * 0.5 * mobileFactor + mousePosition.y * mouseFactor * 0.5, x: mousePosition.x * mouseFactor * 0.5 },
        forest: { y: scrollY * 0.7 * mobileFactor + mousePosition.y * mouseFactor * 0.7, x: mousePosition.x * mouseFactor * 0.7 },
    };
    ...
    return (
        <div className="relative h-[200vh] w-full overflow-x-hidden bg-[#0b0f0b] font-sans">
            <div className="sticky top-0 h-screen overflow-hidden">
                ...
                {/* Backgrounds (Sky & Mountain) - HINDI PINAKIALAMAN */}
                ...
                {/* 3. Text Container - ITO LANG ANG INAYOS (AUTO RESIZE & ONE LINE) */}
                <div
                    className="absolute left-1/2 z-20 flex -translate-x-1/2 flex-col items-center w-[95%] select-none pointer-events-none"
                    style={{
                        top: isMobile ? "45%" : "50%",
                        transition: "transform 3000ms cubic-bezier(0.16, 1, 0.3, 1), opacity 3000ms ease",
                        transform: isVisible
                ...
                >
                    {/* TITLE: Isang linya at kusang liliit kapag mahaba ang text */}
                    <h1
                    ...
                    {/* SUBTITLE: Isang linya at agresibong auto-resize base sa screen at length */}
                    <h1
                ...
                {/* Forest Layer & Gradient - HINDI PINAKIALAMAN */}
