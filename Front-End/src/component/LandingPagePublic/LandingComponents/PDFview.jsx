                ...
                <div className="w-full max-w-7xl px-2 sm:px-4">
                    <div className="flex flex-col overflow-hidden rounded-xl border shadow-2xl xs:h-[600px]">
                        ...
                        <div className="relative flex-grow bg-gray-100" style={{ height: 'calc(100% - 57px)' }}>
                            ...
                            {/* Blur Overlay Container - INCREASED HEIGHT */}
                            <div className="absolute inset-0 pointer-events-none">
                                {/* Mobile View - Increased height from 70% to 85% */}
                                {isMobile ? (
                                    <>
                                        {/* Glass Overlay - Covering 85% of bottom (increased) */}
                                        <div className="absolute bottom-0 left-0 right-0 h-[85%] bg-gradient-to-t from-white/90 via-white/70 to-transparent backdrop-blur-sm border-t border-white/30">
                                            {/* Centered Content */}
                                                ...
                                                <div className="text-center max-w-xs backdrop-blur-sm p-2">
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex items-center justify-center gap-2">
                                                            ...
                                                            <p className="text-xs text-gray-700">
                                                                Barangay Calumpang, Naval, Biliran
                                                            </p>
                                                        </div>
                                                    </motion.div>
                                                    ...
                                                    >
                                                        ...
                                                        <p className="text-[11px] text-gray-600 mt-4 bg-white/50 backdrop-blur-sm rounded-lg p-3 border border-white/30">
                                                            <span className="font-semibold text-blue-700">↑ Scroll up for preview</span><br/>
                                                            First few pages visible above.<br/>
                                                            Visit the Sangguniang Panlalawigan at the Provincial Capitol for complete document access.
                                                        </p>
                                                    </motion.div>
                                                </div>
                                            </div>
                                    ...
                                    /* Desktop View - Increased height from 400px to 600px */
                                    <div className="absolute bottom-0 left-0 right-0 h-[600px] bg-gradient-to-t from-white via-white/95 to-transparent backdrop-blur-sm flex items-center justify-center">
                                        <div className="text-center px-6 max-w-2xl">
                                            ...
                                            <motion.p
                                                ...
                                                animate={{ opacity: 1, y: 0 }}
                                                transition={{ delay: 0.35, duration: 0.5 }}
                                                className="text-xl font-semibold text-blue-700 mb-6"
                                            >
                                                Please Visit the
                                            </motion.p>
                                            ...
                                            >
                                                ...
                                                <p className="text-gray-700 text-xl">
                                                    <span className="font-bold text-blue-700">Biliran Provincial Capitol</span>
                                                </p>
                                                <p className="text-gray-700 text-lg mt-1">
                                                    Barangay Calumpang, Naval, Biliran
                                                </p>
                                                <p className="text-gray-600 mt-4 text-base">
                                                    The Sangguniang Panlalawigan (Provincial Board) is the legislative body of the province of Biliran,<br/>
                                                    located within the Provincial Capitol compound in the capital town of Naval.
                                                </p>
                                            </motion.div>
                    ...
                    <div className="mt-4 sm:mt-6 text-center">
                        <p className="text-xs sm:text-sm text-gray-400 px-2">
                            {isMobile 
                                ? "Preview available • Visit the Sangguniang Panlalawigan at Biliran Provincial Capitol for complete access" 
                                : "Document viewer • For full access, please visit the Sangguniang Panlalawigan at the Biliran Provincial Capitol"
                            }
                        </p>
                    </div>
                </div>
