...
import { Edit, Trash, Plus, ChevronLeft, ChevronRight, User } from "lucide-react";
              ...
              <tr>
                <td colSpan="6" className="px-6 py-12 text-center">
                  <div className="flex flex-col items-center justify-center gap-2 text-gray-500 dark:text-gray-400">
                    ...
                    <p className="mt-3 font-medium">No admins found</p>
                    <p className="text-sm">Add a new admin to get started</p>
                  </div>
                </td>
              </tr>
            )}
              ...
              {[...Array(totalPages)].map((_, i) => (
                <button
                  ...
                  className={`h-8 w-8 rounded-md text-sm ${
                    currentPage === i + 1 ? "bg-blue-600 text-white" : "border border-gray-300 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700 dark:text-white"
                  }`}
                >
                  {i + 1}
                </button>
