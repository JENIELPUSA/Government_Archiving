...
const RecentPosts = () => {
  ...
  return (
    <div className=" flex items-center justify-center bg-gray-100 mb-6">
      <div className="w-full max-w-sm overflow-hidden rounded-lg border border-gray-200 bg-white shadow-md md:max-w-md lg:max-w-lg">
        <div className="p-6 md:p-8">
          <h3 className="mb-5 border-b-2 border-gray-200 pb-3 text-sm font-bold uppercase tracking-wide text-gray-700">
            RECENT POSTS
          </h3>
            ...
            {recentPosts.map((post, index) => (
              <li key={post._id || index} className="mb-4 flex items-start last:mb-0">
                ...
                <div className="flex-1">
                  <a
                    href="#"
                    className="text-sm font-normal leading-tight text-blue-600 transition-colors duration-200 hover:underline"
                  >
                    {post.title}
                  </a>
