...
import MayorLayout from "../../component/PublicView/MayorLayout";
import { User } from 'lucide-react';
import Breadcrumb from "./Breadcrumb";

// 👇 Wrapper to track mount/unmount of MayorLayout
...
const BoardMemberLayout = ({ Position, onBack }) => {
  ...
  useEffect(() => {
    if (activePosition === "Mayor" || activePosition === "Vice Mayor") {
      return;
    }
  ...
  const sidebarPositions = ["Mayor", "Vice Mayor", "Board Member"];
  ...
  if (selectedMember) {
    return <TrackedMayorLayout fullName={selectedMember.fullName} member={selectedMember} />;
  }

  if (activePosition === "Mayor") {
    return <TrackedMayorLayout Position="Mayor" />;
  }

  if (activePosition === "Vice Mayor") {
    return <TrackedMayorLayout Position="Vice-Mayor" />;
  }
          ...
          <div className="flex-1">
            ...
            {isLoading ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <h3 className="text-sm font-semibold text-blue-800">
                        Hon. {member.fullName || "Name not available"}
                      </h3>
              ...
              <div className="col-span-full py-12 text-center text-gray-500">
                ...
                <span className="font-medium text-gray-700">{activePosition}</span>
              </div>
            )}
              ...
              <div className="sticky top-24 animate-pulse rounded-lg bg-white p-4 shadow-sm">
                ...
                <ul className="space-y-3">
                  {sidebarPositions.map((_, i) => (
                    <li key={i} className="h-4 rounded bg-gray-200"></li>
                  ))}
                </ul>
              </div>
            ) : (
