...
const DocumentSection = () => {
    ...
    useEffect(() => {
        let currentFilteredData = isFile?.filter((item) => {
            const notArchived = item.ArchivedStatus === "Active";
            const notDraft = item.status !== "Draft";
            ...
            return notArchived && notDraft && matchesSearch && matchesDate;
        });
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead className="bg-indigo-600 text-white">
                            <tr>
                                ...
                                <th className="px-5 py-3 text-left text-xs font-medium uppercase tracking-wider">Approver</th>
                            ...
                            {currentItems.length > 0 ? (
                                currentItems.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="whitespace-nowrap px-5 py-3 text-sm text-gray-700 dark:text-gray-300">{item.category}</td>
