...
const EditDocumentModal = ({ show, document, onSave, onClose }) => {
  ...
  // Normalize category data to ensure consistent string format
  ...
  // Initialize and update document data
  useEffect(() => {
...
const handleSubmit = async(e) => {
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-gray-900 bg-opacity-60 p-4">
