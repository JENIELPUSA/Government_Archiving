...
export const DocumentDetailsPanel = ({ document, onClose }) => {
    ...
    const handdlerestore = async (item) => {
        setIsLoading(true);
        try {
            const newStatus = item.ArchivedStatus === "For Restore" || item.ArchivedStatus === "Archived" ? "Active" : "For Restore";
        ...
        <AnimatePresence>
            {document && (
                <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="fixed inset-0 z-[50] flex items-center justify-center overflow-y-auto bg-black bg-opacity-40 p-4 backdrop-blur dark:bg-gray-900/80"
                >
                    <motion.div
                        ...
                        style={{ maxHeight: "85vh" }} // Added fixed max height
                    >
                        <button
                            onClick={onClose}
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <div className="mb-5 max-h-32 overflow-y-auto">
                                        {" "}
                                        {/* Added fixed height for summary */}
