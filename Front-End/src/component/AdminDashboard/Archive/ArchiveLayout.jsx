...
const SkeletonSearchAndFilter = () => (
    <div className="flex animate-pulse flex-col items-end space-y-4">
...
const ArchiveLayout = () => {
    ...
    if (selectedDocument) {
        ...
        if (selectedMainFolder && selectedYear && selectedCategory) {
            ...
            const currentYears = organizedData[selectedMainFolder]?.years
                ? Object.keys(organizedData[selectedMainFolder].years).sort((a, b) => parseInt(b) - parseInt(a))
                : [];
            content = (
                <div className="grid grid-cols-1 gap-6 p-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
