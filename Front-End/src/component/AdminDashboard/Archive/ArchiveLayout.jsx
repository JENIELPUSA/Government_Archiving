...
const ArchiveLayout = () => {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [selectedMainFolder, selectedDepartment, selectedYear, selectedCategory, searchQuery, selectedTags]);
  ...
  const paginatedDocuments = currentDocuments.slice(indexOfFirstItem, indexOfLastItem);
  ...
  if (isLoading) {
    ...
    content = (
      <>
        ...
        {/* Pagination controls */}
        {currentDocuments.length > itemsPerPage && (
          <Pagination
