...
const DocumentFilter = ({ documents, onFilterChange }) => {
  // Existing state management remains the same
  ...
  }, [searchTerm, statusFilter, categoryFilter, selectedTags, dateFrom, dateTo, onFilterChange]);

  // Clear functions remain the same
  ...
  return (
    <div className="mb-8 p-6 bg-gray-50 rounded-xl border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700 dark:text-gray-100 transition-colors duration-200">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        {(searchTerm || statusFilter || categoryFilter || selectedTags.length > 0 || dateFrom || dateTo) && (
          <button 
...
// New badge component for consistent styling
