...
const FolderCreationUI = () => {
    const {
        ...
        show,
        setShow,
        fetchFilterTags, GeneralFile, TotalGeneralPages, CurrentGeneralPages, getAllFiles, getTags, istags, istagsFile
    ...
    }, [fileSearchTerm, fileTypeInput, fileDateFrom, fileDateTo, openCategory, showAllTags]);
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6 dark:from-gray-900 dark:to-gray-800">
            {openCategory ? (
                ...
                <CategoryFolder
                    ...
                    setShow={setShow}
                    showAllTags={showAllTags}
                    toggleShowAllTags={toggleShowAllTags}
                    istags={istags}
                    getTags={getTags}
                />
            ) : (
