          ...
          >
                  ...
                  {displayed.map((notif) => {
                    ...
                    return (
                      <motion.li
                        ...
                        className={`relative transition-all duration-200 hover:bg-gray-50 dark:hover:bg-gray-750 ${
            ...
            {notifications.length > 5 && (
              <button
                ...
                className="sticky bottom-0 flex w-full items-center justify-center gap-2 border-t border-gray-200 bg-white py-3 text-sm font-medium text-blue-600 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-750"
              >
                {showAll ? (
                  <>
                    <svg
